                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              onPressed: () async {
                                if (!isAddedWatchlist) {
                                  context.read<MovieDetailBloc>().add(AddToMovieWatchlist(movie, recommendations));
                                } else {
                                  context.read<MovieDetailBloc>().add(RemoveFromMovieWatchlist(movie, recommendations));
                                }
